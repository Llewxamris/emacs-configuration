...
editing prose.
 ...
 #+BEGIN_SRC emacs-lisp
   ...
   Display the candidate, even if it is the sole option.")

     (company-box-backends-colors nil "
   Don't change colour based on the active back-end.")

     (company-box-max-candidates 50 "
   Only grab a maximum of 50 candidates (down from 100).")

     (company-box-icons-alist 'company-box-icons-all-the-icons "
   Use the all-the-icons font-set for the icons."))
#+END_SRC
...
*** Shell Scripts
The built in ~sh-script~ mode paired with ~company-shell~ and Flycheck has been
a good experience. I find it better than using LSP most of the time.
