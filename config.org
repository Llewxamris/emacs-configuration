   ...
   #+BEGIN_SRC emacs-lisp
     ...
     hooks for automatic dynamic block updating."
       ...
       (defun max/org-add-company-ispell-backend ()
         "Adds the iSpell backend for company locally. To use when writting as apposed to programming."
         (eval-when-compile (defvar company-ispell))
         (make-local-variable 'company-backends)
         (push 'company-backends 'company-ispell))
