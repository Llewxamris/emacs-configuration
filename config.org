...
#+BEGIN_SRC emacs-lisp
  (use-package semantic
    :ensure nil
    :hook (c-mode . max-semantic-functions)
    :commands (global-semanticdb-minor-mode
               global-semantic-idle-scheduler-mode
               global-semantic-idle-summary-mode
               global-semantic-idle-local-symbol-highlight-mode)
    :init
    (defun max-semantic-functions ()
      (semantic-mode)
      ;; Enable SemanticDB for that sweet caching.
      (global-semanticdb-minor-mode)
      ;; Automatically re-parse source code when Emacs is idling.
      (global-semantic-idle-scheduler-mode)
      ;; When idling, give a summary of the symbol at point in the minibuffer.
      (global-semantic-idle-summary-mode)
      ;; When idling, highlight additional uses of the current symbol at point.
      (global-semantic-idle-local-symbol-highlight-mode)))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package c-mode
    ...
    (defun max-c-mode-hook ()
      (hs-minor-mode)
      (max-set-company-backends '(company-clang
                                  company-semantic
                                  company-capf
                                  company-yasnippet))))
#+END_SRC
