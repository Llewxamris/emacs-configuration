...
*** Global Access
	 ...
	 - Space + (o)rg-mode
		 ...
		 - t(o)do list ::  View a list of all non-done tasks
		 - (s)earch view :: Create a list based off of search terms
		 - (t)ags view :: Create a list of tasks based on tags
		 - Clock (0)ut :: Clock out of the active timer
	 as yesterday
