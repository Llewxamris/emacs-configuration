...
#  LocalWords:  flyspell lang lsp flycheck imenu ibuffer Avy
...
but it's true. For any language I use, I try to leverage a Language Server if available. Using a lang server simplifies the setup, and allows me to share one
