...
#+BEGIN_SRC emacs-lisp :tangle early-init.el
  ...
  ;; Set the initial frames font.
  ;; (add-to-list 'default-frame-alist '(font . "Go Mono-09"))

  ;; Explicitly set the font backend to Cairo with HarfBuzz as the shaping engine. This
  ;; opens up the door to better ligature support in the future.
